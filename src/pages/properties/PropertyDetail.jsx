...
export function PropertyDetail() {
  ...
  const fetchProperty = async () => {
    ...
    try {
      ...
      // Load primary contact for hero display
  ...
  const propertyTypeOptions = ['Residential', 'Commercial', 'Industrial', 'Mixed-Use', 'Agricultural']
  const counties = ['Peoria', 'Tazewell', 'Woodford', 'Other']

  // Build merged address string for map embed
  ...
  const tabs = ['Overview', 'Physical', 'Units & Space', 'Tax & Assessment', 'Residential', 'Multifamily', 'Notes']
  ...
  const TabContent = () => {
    switch (activeTab) {
      case 'Overview':
        return (
          <div style={grid2col}>
            <FieldRow label="Parcel ID" value={form.parcel_id} editing={editing} onChange={v => f('parcel_id', v)} />
            <FieldRow label="Parcel ID 2-5" value={form.parcel_id_2_5} editing={editing} onChange={v => f('parcel_id_2_5', v)} />
            ...
            <FieldRow label="Zip" value={form.zipcode} editing={editing} onChange={v => f('zipcode', v)} />
            <FieldRow label="Property Name" value={form.property_name} editing={editing} onChange={v => f('property_name', v)} />
            ...
            <FieldRow label="Property Type" value={form.property_type} editing={editing} type="select" options={propertyTypeOptions} onChange={v => f('property_type', v)} />
            <FieldRow label="Property Subtype" value={form.property_subtype} editing={editing} onChange={v => f('property_subtype', v)} />
            ...
            <FieldRow label="Sale Price/SF" value={form.sale_price_sf} editing={editing} type="number" onChange={v => f('sale_price_sf', v)} />
          </div>
        )
      case 'Physical':
        return (
          <div style={grid2col}>
            ...
            <FieldRow label="Total Land SF" value={form.total_land_sf} editing={editing} type="number" onChange={v => f('total_land_sf', v)} />
            <FieldRow label="Total Building SF" value={form.total_building_sqft} editing={editing} type="number" onChange={v => f('total_building_sqft', v)} />
            ...
            <FieldRow label="Land to Bldg Ratio" value={form.land_bldg_ratio} editing={editing} type="number" onChange={v => f('land_bldg_ratio', v)} />
            <FieldRow label="# Buildings" value={form.num_buildings} editing={editing} type="number" onChange={v => f('num_buildings', v)} />
            <FieldRow label="# Stories" value={form.num_stories} editing={editing} type="number" onChange={v => f('num_stories', v)} />
            ...
            <FieldRow label="Ceiling Height" value={form.ceiling_height} editing={editing} onChange={v => f('ceiling_height', v)} />
      ...
      case 'Units & Space':
        return (
          <div style={grid2col}>
            <FieldRow label="# Residential Units" value={form.num_residential_units} editing={editing} type="number" onChange={v => f('num_residential_units', v)} />
            <FieldRow label="# Commercial Units" value={form.num_commercial_units} editing={editing} type="number" onChange={v => f('num_commercial_units', v)} />
            <FieldRow label="Total Units" value={form.total_units} editing={editing} type="number" onChange={v => f('total_units', v)} />
            <FieldRow label="# Apartments" value={form.num_apartments} editing={editing} type="number" onChange={v => f('num_apartments', v)} />
            <FieldRow label="Apartment Mix" value={form.apartment_mix} editing={editing} onChange={v => f('apartment_mix', v)} />
            <FieldRow label="Residential SF" value={form.residential_sf} editing={editing} type="number" onChange={v => f('residential_sf', v)} />
            <FieldRow label="Retail SF" value={form.retail_sf} editing={editing} type="number" onChange={v => f('retail_sf', v)} />
            <FieldRow label="Office SF" value={form.office_sf} editing={editing} type="number" onChange={v => f('office_sf', v)} />
            <FieldRow label="Warehouse SF" value={form.warehouse_sf} editing={editing} type="number" onChange={v => f('warehouse_sf', v)} />
            <FieldRow label="Manufacturing SF" value={form.manufacturing_sf} editing={editing} type="number" onChange={v => f('manufacturing_sf', v)} />
            <FieldRow label="Comm Garage SF" value={form.comm_garage_sf} editing={editing} type="number" onChange={v => f('comm_garage_sf', v)} />
      ...
      case 'Tax & Assessment':
        return (
          <div style={grid2col}>
            ...
            <FieldRow label="Bldg Assessment/SF" value={form.bldg_assessment_sf} editing={editing} type="number" onChange={v => f('bldg_assessment_sf', v)} />
      ...
      case 'Residential':
        return (
          <div style={grid2col}>
            <FieldRow label="# Bedrooms" value={form.num_bedrooms} editing={editing} type="number" onChange={v => f('num_bedrooms', v)} />
            <FieldRow label="# Full Baths" value={form.num_full_baths} editing={editing} type="number" onChange={v => f('num_full_baths', v)} />
            <FieldRow label="# Half Baths" value={form.num_half_baths} editing={editing} type="number" onChange={v => f('num_half_baths', v)} />
            <FieldRow label="# Fireplaces" value={form.num_fireplaces} editing={editing} type="number" onChange={v => f('num_fireplaces', v)} />
            <FieldRow label="A/C" value={form.ac} editing={editing} onChange={v => f('ac', v)} />
            <FieldRow label="Total Living Area SF" value={form.total_living_area_sf} editing={editing} type="number" onChange={v => f('total_living_area_sf', v)} />
            <FieldRow label="Main Living Area SF" value={form.main_living_area_sf} editing={editing} type="number" onChange={v => f('main_living_area_sf', v)} />
            <FieldRow label="Recreation Area SF" value={form.recreation_area_sf} editing={editing} type="number" onChange={v => f('recreation_area_sf', v)} />
            <FieldRow label="Attached Garage SF" value={form.attached_garage_sf} editing={editing} type="number" onChange={v => f('attached_garage_sf', v)} />
            <FieldRow label="Detached Garage SF" value={form.detached_garage_sf} editing={editing} type="number" onChange={v => f('detached_garage_sf', v)} />
            <FieldRow label="Basement Y/N" value={form.has_basement} editing={editing} onChange={v => f('has_basement', v)} />
            <FieldRow label="Basement SF" value={form.basement_sf} editing={editing} type="number" onChange={v => f('basement_sf', v)} />
            <FieldRow label="Finished Basement SF" value={form.finished_basement_sf} editing={editing} type="number" onChange={v => f('finished_basement_sf', v)} />
          </div>
        )
      case 'Multifamily':
        return (
          <div style={grid2col}>
            <FieldRow label="Baths/Unit" value={form.baths_per_unit} editing={editing} type="number" onChange={v => f('baths_per_unit', v)} />
            <FieldRow label="Living SF/Unit" value={form.living_sf_per_unit} editing={editing} type="number" onChange={v => f('living_sf_per_unit', v)} />
            <FieldRow label="Basement SF/Unit" value={form.basement_sf_per_unit} editing={editing} type="number" onChange={v => f('basement_sf_per_unit', v)} />
            <FieldRow label="Finished Basement SF/Unit" value={form.finished_basement_sf_per_unit} editing={editing} type="number" onChange={v => f('finished_basement_sf_per_unit', v)} />
            <FieldRow label="Garage/Unit" value={form.garage_per_unit} editing={editing} type="number" onChange={v => f('garage_per_unit', v)} />
            ...
            <FieldRow label="Individual Laundry" value={form.individual_laundry} editing={editing} onChange={v => f('individual_laundry', v)} />
            <FieldRow label="Vacant SF" value={form.vacant_sf} editing={editing} type="number" onChange={v => f('vacant_sf', v)} />
            <FieldRow label="Occupancy %" value={form.occupancy_pct} editing={editing} type="number" onChange={v => f('occupancy_pct', v)} />
            <FieldRow label="# Parking Spaces" value={form.num_parking_spaces} editing={editing} type="number" onChange={v => f('num_parking_spaces', v)} />
          </div>
        )
      case 'Notes':
        return (
      ...
      <div style={{ maxWidth: 1400, margin: '0 auto' }}>
        ...
        <div style={{ background: '#fff', border: '1px solid #e2e8f0', borderRadius: 16, overflow: 'hidden', marginBottom: 24, boxShadow: '0 1px 8px rgba(0,0,0,0.06)' }}>
          <div style={{ padding: '24px 28px' }}>
            ...
            {/* Row 2: Name + Address + Owner Info | Photo + Map */}
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }}>

              {/* LEFT: Name, address, owner */}
              <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                <div>
                  <h1 style={{ fontSize: 28, fontWeight: 800, color: '#1e293b', margin: '0 0 6px 0', lineHeight: 1.2 }}>
                    {form.property_name || form.address || 'Unnamed Property'}
                  </h1>
                  {fullAddress && (
                    <p style={{ margin: '0 0 16px', fontSize: 13, color: '#64748b', display: 'flex', alignItems: 'center', gap: 5 }}>
                      📍 {fullAddress}
                    </p>
                  )}
                </div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                        ...
                        <button
                          ...
                          style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 0, color: '#1e40af', fontSize: 14, fontWeight: 700, textDecoration: 'underline' }}
                        >
              ...
              {/* RIGHT: Photo Gallery + Google Maps side by side */}
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                <div style={{ borderRadius: 12, border: '1px solid #e2e8f0', overflow: 'hidden', background: '#f8fafc' }}>
                  <PhotoGallery
                    ...
                    recordId={id}
                    mode="wide"
                    onMainPhotoChange={url => setProperty(p => ({ ...p, image_url: url }))}
                  />
                </div>
                  ...
                  {mapsAddress
                    ? (
                      <iframe
                        ...
                        style={{ display: 'block', minHeight: 200, border: 0 }}
                        src={`https://maps.google.com/maps?q=${mapsAddress}&output=embed&z=15`}
                        allowFullScreen
                        loading="lazy"
                      />
                    )
                    : (
                      <div style={{ height: '100%', minHeight: 200, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#f8fafc', color: '#94a3b8', fontSize: 12, gap: 8 }}>
                        <span style={{ fontSize: 32 }}>🗺️</span>
                        <span>No address for map</span>
                      </div>
                    )
                  }
                </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(120px, 1fr))', gap: 0, borderTop: '1px solid #e2e8f0', paddingTop: 14, marginTop: 20 }}>
              ...
              <StatCell label="# Units"           value={form.total_units || form.num_residential_units} />
              <StatCell label="Year Built"        value={[form.year_built, form.year_renovated].filter(Boolean).join(' / ') || null} />
              <StatCell label="Last Sold Price"   value={form.sales_price ? fmt.currency(form.sales_price) : null} color="#f59e0b" />
              <StatCell label="Last Sold Date"    value={form.sale_date ? fmt.date(form.sale_date) : null} />
            </div>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', gap: '24px' }}>
          ...
          <div style={{ flex: 1, background: '#fff', border: '1px solid #e2e8f0', borderRadius: 12, padding: '20px 24px', boxShadow: '0 1px 4px rgba(0,0,0,0.04)' }}>
            {/* Tab bar */}
            <div style={{ display: 'flex', gap: '4px', borderBottom: '1px solid #e2e8f0', marginBottom: '24px', flexWrap: 'wrap' }}>
              {tabs.map(tab => (
                <button
                  key={tab}
